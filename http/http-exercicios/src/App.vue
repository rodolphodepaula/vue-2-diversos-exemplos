		...
		<b-card>
			<b-form-group label="Nome">
				<b-form-input type="text" size=lg
					v-model="usuario.nome" placeholder="Nome" />
			</b-form-group>
			<b-form-group label="E-mail">
				<b-form-input type="email" size=lg
					v-model="usuario.email" placeholder="E-mail" />
			</b-form-group>
			<hr>
			<b-button @click="salvar" 
				size="lg" variant="primary" class="mr-2">Salvar</b-button>
			<b-button @click="obterUsuarios"
				size="lg" variant="success">Obter Usuarios</b-button>
		</b-card>
		<hr>
		<b-list-group>
			<b-list-group-item v-for="(usuario, id) in usuarios" :key="usuario">
